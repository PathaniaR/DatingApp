...
namespace DatingApi.SignalR
{
    ...
    public class PresenceHub : Hub  
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.Others.SendAsync("UserIsOnline", Context.UserIdentifier, Context.User.GetUserName());
        ...
        {
            await this.tracker.UserDisconnected(Context.UserIdentifier,Context.ConnectionId);
